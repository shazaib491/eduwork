                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form acton="operations/authenticate.php" method="POST">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group mt-4 mb-0"><input type="submit" class="btn btn-primary btn-block" name="register" value="Create Account"></div>
                                        </form>
                                    </div>
